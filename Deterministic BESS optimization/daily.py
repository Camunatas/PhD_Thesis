...
# Batt_Cost= 26.01*1000* Batt_Enom  # [€] BESS cost
Batt_Cost = 0
...
#%% -- Function callings --
SOCs, Bids = arbitrage(Batt_SOC_init, real_prices, Batt_Enom, Batt_Pnom, 
                       Batt_Eff, Batt_Cost)
...
plt.bar(ticks_x, real_prices, align='edge', width=1, edgecolor='black',color='r', label='Predicted price')
# plt.xticks(np.arange(0, 24, 1), dates_label, rotation=45)
if prediction_comparator: 
    plt.legend()
# Adding labels
...
# ticks_y = np.arange(-Batt_Pnom*1, Batt_Pnom*1, 1)                     	# Thick horizontal grid spacing
